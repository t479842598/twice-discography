    ...
    <n-layout-header bordered class="topbar">
      ...
      <div class="topbar-actions">
        ...
        <n-button class="theme-toggle" circle secondary :aria-label="themeStore.isDark ? t('theme.toLight') : t('theme.toDark')" @click="themeStore.toggleTheme">
          <svg v-if="themeStore.isDark" class="theme-toggle-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true" focusable="false"><circle cx="12" cy="12" r="4"/><path d="M12 2v2m0 16v2M4.93 4.93l1.41 1.41m11.32 11.32 1.41 1.41M2 12h2m16 0h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41"/></svg>
          <svg v-else class="theme-toggle-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
        </n-button>
